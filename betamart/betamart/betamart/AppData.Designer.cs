...
namespace betamart {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, string Type, string Price, string Size, byte[] Image) {
...
namespace betamart.AppDataTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Size` IS NULL) OR (`Size` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`ProductName`, `Type`, `Price`, `Size`, `Image`) VALUES (" +
                "?, ?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `ProductName` = ?, `Type` = ?, `Price` = ?, `Size` = ?, `Image` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `Type` IS NULL) OR (`Type` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Size` IS NULL) OR (`Size` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, Type, Price, [Size], [Image] FROM Products";
        ...
        public virtual int Fill(AppData.ProductsDataTable dataTable) {
        ...
        public virtual AppData.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppData.ProductsDataTable dataTable = new AppData.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppData.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, string Original_Type, string Original_Price, string Original_Size) {
        ...
        public virtual int Insert(string ProductName, string Type, string Price, string Size, byte[] Image) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, string Type, string Price, string Size, byte[] Image, int Original_ProductID, string Original_ProductName, string Original_Type, string Original_Price, string Original_Size) {
            if ((ProductName == null)) {
